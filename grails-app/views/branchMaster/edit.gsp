...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-branchMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${branchMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${branchMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${branchMasterInstance?.version}"/>
