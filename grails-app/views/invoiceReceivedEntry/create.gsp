...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="create-invoiceReceivedEntry" class="content scaffold-create" role="main">
            ...
            <g:form action="save">
                ...
                <fieldset class="buttons" style="margin-left: 100px; margin-right: 50px;">
                    <g:submitButton name="create" class="btn btn-info btn-small" onclick="return checkValidate()"
