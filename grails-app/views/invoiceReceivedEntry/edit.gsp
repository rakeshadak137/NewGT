...
<head>
    ...
    <script>
        function checkValidate(){
            if(!valid){
                alert("There is no Transaction. Please add LR.")
                return false
            }else{
                return true;
            }
...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-invoiceReceivedEntry" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${invoiceReceivedEntryInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${invoiceReceivedEntryInstance}" var="error">
            ...
            <g:form method="post">
                ...
                <g:hiddenField name="version" value="${invoiceReceivedEntryInstance?.version}"/>
                ...
                <fieldset class="buttons" style="margin-left: 100px; margin-right: 50px;">
                    <g:actionSubmit class="btn btn-info btn-small" action="update" onclick="return checkValidate()"
