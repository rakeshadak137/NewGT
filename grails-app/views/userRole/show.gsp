            ...
            <div style="margin-left: 50px; margin-right: 50px;" class="widget-main padding-8">
                <ol class="property-list userRole">
                    ...
                    <g:if test="${userRoleInstance?.user}">
                        <li class="fieldcontain">
                            <span id="user-label" class="property-label"><g:message
                                    code="userRole.user.label"
                                    default="User"/></span> :-
                        
                            <span class="property-value" aria-labelledby="user-label">
                                ${userRoleInstance?.user?.encodeAsHTML()}</span>
                    ...
                    <g:if test="${userRoleInstance?.role}">
                        <li class="fieldcontain">
                            <span id="role-label" class="property-label"><g:message
                                    code="userRole.role.label"
                                    default="Role"/></span> :-
                        
                            <span class="property-value" aria-labelledby="role-label">
                                ${userRoleInstance?.role?.encodeAsHTML()}</span>
                ...
                <g:form>
                    <fieldset class="buttons" style="margin-left: 50px; margin-right: 50px;">
                        ...
                        <g:link class="btn btn-info btn-small" action="edit" id="${userRoleInstance?.id}"><g:message
