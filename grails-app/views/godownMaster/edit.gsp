...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-godownMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${godownMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${godownMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${godownMasterInstance?.version}"/>
            <fieldset class="form">
