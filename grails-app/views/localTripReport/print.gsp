...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'billAgainstLR.label', default: 'Local Trip Report')}"/>
                    ...
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="span2">
                                        <a ng-href="/${grailsApplication.config.erpName}/localTripReport/allInOneLocalTripReport?scrid=${session['activeScreen'].id}&fromDate={{fromDate}}&toDate={{toDate}}&format=PDF"
                        ...
                        <div id="tabs-2">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="span2">
                                        <a ng-href="/${grailsApplication.config.erpName}/localTripReport/allInOneLocalTripReport?scrid=${session['activeScreen'].id}&fromDate={{fromDatep}}&toDate={{toDatep}}&fromParty={{fromParty}}&toParty={{toParty}}&format=PDF"
                                           class="btn btn-primary btn-mini" target="_blank">
                                            Print Report</a>
                                    </div>
                                </div>
                        ...
                        <div id="tabs-3">
                            <div class="row-fluid">
                                <div class="span12">
                                    ...
                                    <div class="span4">
                                        <select id="vehicle" ng-model="vehicleNo"
                                                ng-options="r.id as r.state +'-'+ r.rto +' '+ r.series +' '+ r.vehicleNo for r in vehicleList"></select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="span2">
                                        <a ng-href="/${grailsApplication.config.erpName}/localTripReport/allInOneLocalTripReport?scrid=${session['activeScreen'].id}&fromDate={{fromDatev}}&toDate={{toDatev}}&vNo={{vehicleNo}}&format=PDF"
                                           class="btn btn-primary btn-mini" target="_blank">
                                            Print Report</a>
                                    </div>
                                </div>
