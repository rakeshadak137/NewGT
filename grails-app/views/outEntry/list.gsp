    ...
    <script>
        ...
        function ListController($scope, $http) {
            ...
            function init() {
                ...
                $http.get("/${grailsApplication.config.erpName}/OutEntry/getList")
...
<div class="main-content">
    ...
    <div class="row-fluid" style="margin-left:30px; width:95%; margin-top: 15px;">
        ...
        <div id="list-outEntry" class="content scaffold-list" role="main">
                        ...
                        <tr ng-repeat="r in DataList  | filter : search | startFrom: currentPage * pageSize | limitTo: pageSize">
                            ...
                            <td style="width: 50px;">
                                <g:form action="delete" controller="outEntry"
                                    ...
                                    <a ng-href="/${grailsApplication.config.erpName}/outEntry/show?id={{r.id}}&scrid=${session['activeScreen'].id}"><i
                            ...
                            <td><a ng-href="/${grailsApplication.config.erpName}/outEntry/print_action?id={{r.id}}&scrid=${session['activeScreen'].id}"
