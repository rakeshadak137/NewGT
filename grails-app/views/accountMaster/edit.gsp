...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-accountMaster" class="content scaffold-edit" role="main">
            <div class="table-header">
                <g:message code="default.edit.label" args="[entityName]"/>

                <g:link class="btn btn-info btn-small pull-right" style="margin-right: 5px;margin-top: 3px"
                        action="list" params="${[scrid:session['activeScreen'].id]}"><i class="icon-ok bigger-50"></i> List</g:link>
                <g:link class="btn btn-info btn-small pull-right" style="margin-right: 5px;margin-top: 3px"
            ...
            <g:hasErrors bean="${accountMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${accountMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${accountMasterInstance?.version}"/>
            <fieldset class="form">
