...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="create-templateSubject" class="content scaffold-create" role="main">
            ...
            <g:hasErrors bean="${templateSubjectInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${templateSubjectInstance}" var="error">
