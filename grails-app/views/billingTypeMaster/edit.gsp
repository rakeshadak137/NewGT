...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-billingTypeMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${billingTypeMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${billingTypeMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${billingTypeMasterInstance?.version}"/>
            <fieldset class="form">
