...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-cityMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${cityMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${cityMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${cityMasterInstance?.version}"/>
            <fieldset class="form">
