...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-categoryMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${categoryMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${categoryMasterInstance}" var="error">
            ...
            <g:form method="post" >
            <g:hiddenField name="id" value="${categoryMasterInstance?.id}"/>
            <g:hiddenField name="version" value="${categoryMasterInstance?.version}"/>
            <fieldset class="form">
