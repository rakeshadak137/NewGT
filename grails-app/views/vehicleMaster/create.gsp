...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="create-vehicleMaster" class="content scaffold-create" role="main">
            ...
            <g:hasErrors bean="${vehicleMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${vehicleMasterInstance}" var="error">
