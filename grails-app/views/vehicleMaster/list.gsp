    ...
    <script>
        function ListController($scope, $http) {
            ...
            function init() {
                ...
                $http.get("/${grailsApplication.config.erpName}/vehicleMaster/showList")
                        .success(function(data){
                            $scope.DataList=data;
                        });

                %{--$scope.DataList = ${com.master.VehicleMaster.findAllByIsActive(true) as grails.converters.JSON};--}%
            }
...
<div class="main-content">
    ...
    <div class="row-fluid" style="margin-left:30px; width:95%; margin-top: 15px;">
        ...
        <div id="list-vehicleMaster" class="content scaffold-list" role="main">
            ...
            <div role="grid" class="dataTables_wrapper" id="sample-table-2_wrapper">
                ...
                <div role="grid" class="dataTables_wrapper" id="sample-table_wrapper">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample-table-3"
                        ...
                        <tr ng-repeat="r in DataList  | filter : search | startFrom: currentPage * pageSize | limitTo: pageSize">
                            ...
                            <td style="width: 50px;">
                                <g:form action="delete" controller="vehicleMaster"
                                    ...
                                    <a ng-href="/${grailsApplication.config.erpName}/vehicleMaster/edit?id={{r.id}}&scrid=${session['activeScreen'].id}"><i
                ...
                <div align="center" class="well">
                    <h4 style="margin-bottom: 0px;margin-top: 0px;">Total Vehicles : {{DataList.length}}</h4>
                </div>
