...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="create-LREntry" class="content scaffold-create" role="main">
            <div class="table-header">
                <g:message code="default.create.label" args="[entityName]" /> ${session['branch'].branchName}
            ...
            <g:hasErrors bean="${LREntryInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${LREntryInstance}" var="error">
