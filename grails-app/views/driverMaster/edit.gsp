...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-driverMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${driverMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${driverMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${driverMasterInstance?.version}"/>
            <fieldset class="form">
