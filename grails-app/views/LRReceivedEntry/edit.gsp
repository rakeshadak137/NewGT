...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-LRReceivedEntry" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${LRReceivedEntryInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${LRReceivedEntryInstance}" var="error">
            ...
            <g:form method="post">
                ...
                <g:hiddenField name="version" value="${LRReceivedEntryInstance?.version}"/>
