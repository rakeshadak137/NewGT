...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-divisionMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${divisionMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${divisionMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${divisionMasterInstance?.version}"/>
            <fieldset class="form">
