    ...
    <script>
        function ListController($scope, $http) {
            ...
            function init() {
                ...
                $scope.DataList = ${User.list() as grails.converters.JSON};
            }
        ...
        <div id="list-user" class="content scaffold-list" role="main">
            ...
            <div role="grid" class="dataTables_wrapper" id="sample-table-2_wrapper">
                ...
                <div role="grid" class="dataTables_wrapper" id="sample-table_wrapper">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample-table-3"
                        ...
                        <tr ng-repeat="r in DataList  | filter : search | startFrom: currentPage * pageSize | limitTo: pageSize">
                            ...
                            <td style="width: 50px;">
                                <g:form action="delete" controller="user"
                                    ...
                                    <a ng-href="/${grailsApplication.config.erpName}/user/edit?id={{r.id}}&scrid=${session['activeScreen'].id}"><i
                ...
                <div align="center" class="well">
                    <h4 style="margin-bottom: 0px;margin-top: 0px;">Total Users : {{DataList.length}}</h4>
                </div>
