...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-tripRate" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${tripRateInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${tripRateInstance}" var="error">
            ...
            <g:form method="post">
                ...
                <g:hiddenField name="version" value="${tripRateInstance?.version}"/>
