...
<div class="main-content">
    ...
    <div class="span12" style="width: 95%;margin-top: 15px;">
        ...
        <div id="edit-productMaster" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${productMasterInstance}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${productMasterInstance}" var="error">
            ...
            <g:hiddenField name="version" value="${productMasterInstance?.version}"/>
            <fieldset class="form">
