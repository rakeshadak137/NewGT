    ...
    <script>
        function ListController($scope, $http) {
            ...
            function init() {
                ...
                $scope.currentPage = 0;
                $scope.pageSize = 10;
                $http.get("/${grailsApplication.config.erpName}/productMaster/getList")
...
<div class="main-content">
    ...
    <div class="row-fluid" style="margin-left:30px; width:95%; margin-top: 15px;">
        ...
        <div id="list-productMaster" class="content scaffold-list" role="main">
            ...
            <div role="grid" class="dataTables_wrapper" id="sample-table-2_wrapper">
                ...
                <div role="grid" class="dataTables_wrapper" id="sample-table_wrapper">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample-table-3"
                        ...
                        <tr ng-repeat="r in DataList  | filter : search | startFrom: currentPage * pageSize | limitTo: pageSize">
                            ...
                            <td style="width: 50px;">
                                <g:form action="delete" controller="productMaster"
                                    ...
                                    <a ng-href="/${grailsApplication.config.erpName}/productMaster/edit?id={{r.id}}&scrid=${session['activeScreen'].id}"><i
                ...
                <div align="center" class="well">
                    <h4 style="margin-bottom: 0px;margin-top: 0px;">Total Products : {{DataList.length}}</h4>
                </div>
            </div>
        </div>
