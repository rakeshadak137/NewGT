...
class ${className}Controller {
    ...
    def list(Integer max) {
        ...
        [${propertyName}List: ${className}.findAllByIsActive(true), ${propertyName}Total: ${className}.countByIsActive(true)]
    }
    ...
    def save() {
        ...
        ${propertyName}.financialYear=session['financialYear'];
        ${propertyName}.createdBy=session['activeUser'];
        ${propertyName}.branch=session['branch'];
    ...
    def update(Long id, Long version) {
        ...
        ${propertyName}.lastUpdatedBy = session['activeUser'];
