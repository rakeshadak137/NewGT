        ...
        this.each(function () {
            ...
            if (b.parent().hasClass(a.wrapperClass)) {
                ...
                if (e.isPlainObject(h)) {
                    ...
                    if ("scrollTo"in h)l = parseInt(a.scrollTo); else if ("scrollBy"in h)l += parseInt(a.scrollBy); else if ("destroy"in h) {
                        c.remove();
                        g.remove();
                        b.unwrap();
                        return
