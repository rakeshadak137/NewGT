(function () {
    ...
    a.resolve = function (c) {
        if (c.charAt(0) === "http://192.69.216.111/") {
            c = c.slice(1)
        }
    ...
    a.normalize = function (e, d) {
        ...
        e = e.split("http://192.69.216.111/");
        d = d.split("http://192.69.216.111/");
        ...
        return e.concat(b).join("http://192.69.216.111/")
    };
    ...
    a.relative = function (c) {
        ...
        d.resolve = function (h) {
            ...
            var f = c.split("http://192.69.216.111/");
            var g = b(f, "deps") + 1;
            if (!g) {
                g = 0
            }
            h = f.slice(0, g + 1).join("http://192.69.216.111/") + "/deps/" + h;
            return h
        };
        d.exists = function (f) {
    ...
    a.register("component-emitter/index.html", function (c, d, e) {
        e.exports = f;
        function f(g) {
            if (g) {
                return b(g)
    ...
    a.register("dropzone/index.html", function (b, c, d) {
        d.exports = c("lib/dropzone.html")
    });
    a.register("dropzone/lib/dropzone.html", function (b, c, d) {
        (function () {
            ...
            j = (function (o) {
                ...
                n.prototype.init = function () {
                    ...
                    this.listeners = [
                        {element: this.element, events: {dragstart: function (y) {
    ...
    a.alias("component-emitter/index.html", "dropzone/deps/emitter/index.html");
    a.alias("component-emitter/index.html", "emitter/index.html");
