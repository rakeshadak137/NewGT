...
var v =angular.module('directives', []);

    // Main directive, that just publish a controller
    v.directive('frangTree', function ($parse, $animate) {
        return {
            restrict: 'EA',
   ...
   v.directive('frangTreeRepeat', function ($parse, $animate) {
    ...
    v.directive('frangTreeInsertChildren', function () {
        return {
            restrict: 'EA',
            require: '^frangTree',
    ...
    v.directive('frangTreeDrag', function($parse) {
        return {
            restrict: 'A',
            require: '^frangTree',
            link: function(scope, element, attrs, ctrl) {
    ...
    v.directive('frangTreeDrop', function($parse) {
        return {
            restrict: 'A',
            require: '^frangTree',
            link: function(scope, element, attrs, ctrl) {
